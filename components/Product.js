      ...
      <div className="flex flex-col overflow-hidden justify-end  shadow-[0px_0px_10px_#00000025] rounded-md aspect-square ">
        ...
        <div className="flex items-center justify-between bg-white  z-[1]">
          ...
          <div className="mr-5">
            <motion.button
              whileTap={{ scale: 0.9 }}
              className="hidden text-xs lg:flex  items-center bg-[#3a3a3a] py-1 px-3 rounded-md text-[#e6e6e6] h-5 w-24 justify-center mx-auto hover:bg-[#555] transition-colors duration-200  "
              onClick={(e) => {
